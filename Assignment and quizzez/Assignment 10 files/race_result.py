...
class RaceResult:
    ...
    def __eq__(self, other: 'RaceResult') -> bool:
        """
        >>> rt_1 = RaceTime(2, 34, 5)
        >>> rt_2 = RaceTime(4, 12, 54)
        >>> rt_3 = RaceTime(3, 11, 22)
        
        >>> race_result_1 = RaceResult('Maryam', 'Pakistan', rt_1)
        >>> race_result_2 = RaceResult('Dua', 'Canada', rt_2)
        >>> race_result_3 = RaceResult('Samad', 'Germany', rt_3)
        >>> race_result_4 = RaceResult('Dua', 'UAE', 'rt_2')
        >>> race_result_5 = RaceResult('Maryam', 'Pakistan', rt_1)
        
        >>> race_result_1 == race_result_5
        True
        >>> race_result_2 == race_result_4
        False
        >>> race_result_3 == race_result_1
        False
        """
        return (self.__name == other.get_name() and self.__country == other.get_country()  and self.__finish_time == other.get_finish_time())
